...
async function start() {
  ...
  // Only listen if this file is run directly (not as a module for Vercel)
  if (process.env.NODE_ENV !== "production" || process.env.VITE_ENABLE_SERVER === "true") {
...
// Start the server if explicitly asked or in dev
